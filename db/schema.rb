...
ActiveRecord::Schema.define(version: 20151108221132) do
  ...
  create_table "_user_profile_queue", id: false, force: :cascade do |t|
  ...
  create_table "ads_take_over", force: :cascade do |t|
  ...
  create_table "affiliate_affiliate", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
    t.integer  "user_id",    null: false
    t.boolean  "is_active",  null: false
  ...
  create_table "affiliate_affiliate_deal", force: :cascade do |t|
    t.datetime "updated_at",   null: false
    t.datetime "created_at",   null: false
  ...
  create_table "affiliate_click_location", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
  ...
  create_table "affiliate_click_tracking", force: :cascade do |t|
    t.datetime "updated_at",                       null: false
    t.datetime "created_at",                       null: false
    t.integer  "user_id"
    t.inet     "ip"
  ...
  create_table "affiliate_clickstats_country", force: :cascade do |t|
  ...
  create_table "affiliate_clickstats_item", force: :cascade do |t|
    t.date    "reference_date",                           null: false
    t.integer "item_id"
    t.integer "clicks",                                   null: false
    t.integer "monetized",                                null: false
  ...
  create_table "affiliate_clickstats_site", force: :cascade do |t|
    t.date    "reference_date",                           null: false
  ...
  create_table "affiliate_commision_junction_format", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
  ...
  create_table "affiliate_conversion_test", force: :cascade do |t|
    t.datetime "updated_at",                          null: false
    t.datetime "created_at",                          null: false
  ...
  create_table "affiliate_currency", primary_key: "code", force: :cascade do |t|
    t.string "name", limit: 50, null: false
  end

  add_index "affiliate_currency", ["code"], name: "affiliate_currency_code_like", using: :btree

  create_table "affiliate_data_feed_url", primary_key: "key", force: :cascade do |t|
    t.datetime "updated_at",              null: false
    t.datetime "created_at",              null: false
  ...
  create_table "affiliate_deeplink_variable", force: :cascade do |t|
    t.datetime "updated_at",              null: false
    t.datetime "created_at",              null: false
    t.string   "name",        limit: 255, null: false
  ...
  create_table "affiliate_domain_geo_mapping", force: :cascade do |t|
    t.datetime "updated_at",                    null: false
    t.datetime "created_at",                    null: false
  ...
  create_table "affiliate_euroexchangerate", force: :cascade do |t|
  ...
  create_table "affiliate_mapping_affili_net", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string "country", limit: 255, null: false
    t.string "mid",     limit: 255, null: false
  end

  create_table "affiliate_mapping_commission_junction", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.integer "format_id",                            null: false
    t.integer "homepage_format_id",                   null: false
    t.string  "homepage_foreign_site_id", limit: 255, null: false
  end
  ...
  create_table "affiliate_mapping_ebay", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string "country", limit: 50, null: false
  end

  create_table "affiliate_mapping_link_synergy", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string "homepage_id", limit: 255
    t.string "mid",         limit: 255
  end

  create_table "affiliate_mapping_pepperjam", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string "mid", limit: 255, null: false
  end

  create_table "affiliate_mapping_share_a_sale", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string "banner_id",          limit: 255, null: false
    t.string "homepage_banner_id", limit: 255, null: false
  end

  create_table "affiliate_mapping_tradedoubler", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string "country", limit: 255, null: false
    t.string "mid",     limit: 255, null: false
  end

  create_table "affiliate_mapping_zanox_mapping", primary_key: "sitenetworkmapping_ptr_id", force: :cascade do |t|
    t.string  "homepage_id",     limit: 255, null: false
    t.integer "deeplink_var_id"
    t.string  "extra_qp",        limit: 255
  ...
  create_table "affiliate_network", force: :cascade do |t|
    t.datetime "updated_at",                  null: false
    t.datetime "created_at",                  null: false
    t.string   "name",            limit: 255, null: false
    t.string   "slug",            limit: 255, null: false
    ...
    t.string   "deeplink_qp",     limit: 255
    t.integer  "deeplink_var_id"
    t.string   "site_qp",         limit: 255
    t.string   "clickref_qp",     limit: 255
    t.integer  "content_type_id"
  end
  ...
  create_table "affiliate_site", force: :cascade do |t|
    t.datetime "updated_at",                  null: false
    t.datetime "created_at",                  null: false
    t.string   "name",            limit: 255, null: false
  ...
  create_table "affiliate_site_geo_mapping", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
  ...
  create_table "affiliate_site_network_mapping", force: :cascade do |t|
    t.datetime "updated_at",                  null: false
    t.datetime "created_at",                  null: false
    ...
    t.text     "description"
    t.string   "foreign_site_id", limit: 255
  ...
  create_table "affiliate_sitegeomapping_countries", force: :cascade do |t|
  ...
  create_table "affiliate_skip_monetization", force: :cascade do |t|
    t.datetime "updated_at",                         null: false
    t.datetime "created_at",                         null: false
    t.integer  "site_id",                            null: false
    t.boolean  "is_active",                          null: false
    t.string   "extra_query_parameters", limit: 255
  end

  add_index "affiliate_skip_monetization", ["site_id"], name: "affiliate_skip_monetization_site_id_key", unique: true, using: :btree

  create_table "affiliate_transaction", force: :cascade do |t|
    t.datetime "updated_at",                                                  null: false
    t.datetime "created_at",                                                  null: false
    t.integer  "network_id",                                                  null: false
    ...
    t.string   "network_click_id",       limit: 255
    t.string   "clickref",               limit: 255
    t.integer  "sales"
  ...
  create_table "api_api_partner", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
    t.string   "name",             limit: 255, null: false
  ...
  create_table "classolista_audience", force: :cascade do |t|
    t.string "name",        limit: 255, null: false
    t.string "slug",        limit: 255, null: false
    t.text   "description",             null: false
  end
  ...
  create_table "classolista_audiencemember", force: :cascade do |t|
  ...
  create_table "classolista_churn", force: :cascade do |t|
    t.date    "reference_date",      null: false
  ...
  create_table "classolista_dailystats", force: :cascade do |t|
    t.date    "reference_date",            null: false
  ...
  create_table "classolista_dailyuserstats", force: :cascade do |t|
    t.date    "reference_date", null: false
    t.integer "group_id",       null: false
  ...
  create_table "classolista_find_stat", force: :cascade do |t|
  ...
  create_table "classolista_group", force: :cascade do |t|
  ...
  create_table "classolista_growthstats", force: :cascade do |t|
    t.date    "reference_date",         null: false
  ...
  create_table "classolista_heartbeatstats", force: :cascade do |t|
  ...
  create_table "classolista_lovestats", force: :cascade do |t|
  ...
  create_table "classolista_periodicstats", force: :cascade do |t|
    t.date    "reference_date",                      null: false
  ...
  create_table "classolista_rule", force: :cascade do |t|
  ...
  create_table "classolista_ruleset", force: :cascade do |t|
    t.integer "group_id", null: false
  ...
  create_table "classolista_userstats", force: :cascade do |t|
    t.integer "user_id",             null: false
    t.date    "reference_date",      null: false
  ...
  create_table "content_contentpage", force: :cascade do |t|
  ...
  create_table "content_highlight", force: :cascade do |t|
    t.boolean  "is_active",                null: false
    t.datetime "updated_at",               null: false
    t.datetime "created_at",               null: false
  ...
  create_table "content_highlight_type", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
    t.string   "title",      limit: 128, null: false
    t.string   "slug",       limit: 128, null: false
  ...
  create_table "contest_contest", force: :cascade do |t|
    t.datetime "updated_at",                           null: false
    t.datetime "created_at",                           null: false
    t.string   "name",                     limit: 255, null: false
    ...
    t.string   "user_list_name",           limit: 255
  ...
  create_table "contest_contest_blogger_battle_looks", force: :cascade do |t|
  ...
  create_table "contest_contest_blogger_battle_winners", force: :cascade do |t|
    t.integer "contest_id",  null: false
    t.integer "userlist_id", null: false
  end
  ...
  create_table "contest_dynamic_contest", force: :cascade do |t|
    t.datetime "updated_at",                            null: false
    t.datetime "created_at",                            null: false
  ...
  create_table "contest_dynamiccontest_looks", force: :cascade do |t|
  ...
  create_table "contest_dynamiccontest_looks_winners", force: :cascade do |t|
    t.integer "dynamiccontest_id", null: false
    t.integer "userlist_id",       null: false
  end
  ...
  create_table "contest_entrant", force: :cascade do |t|
    t.integer  "user_id",              null: false
  ...
  create_table "contest_event_special", force: :cascade do |t|
    t.datetime "updated_at",                       null: false
    t.datetime "created_at",                       null: false
    ...
    t.string   "partner_url",          limit: 200
    t.string   "blogger_name",         limit: 255, null: false
  ...
  create_table "contest_event_special_blog", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
  ...
  create_table "contest_event_special_look", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
    t.integer  "event_special_id",             null: false
    t.string   "name",             limit: 255, null: false
  ...
  create_table "contest_event_special_photo", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
    t.integer  "event_special_id",             null: false
    t.string   "name",             limit: 255, null: false
  ...
  create_table "contest_event_special_video", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
    t.integer  "event_special_id",             null: false
    t.string   "name",             limit: 255, null: false
  ...
  create_table "contest_i_frame_contest", force: :cascade do |t|
    t.datetime "updated_at",                           null: false
    t.datetime "created_at",                           null: false
    t.string   "name",                     limit: 255, null: false
    t.string   "slug",                     limit: 50,  null: false
  ...
  create_table "contest_iframecontest_looks", force: :cascade do |t|
  ...
  create_table "contest_iframecontest_looks_winners", force: :cascade do |t|
    t.integer "iframecontest_id", null: false
    t.integer "userlist_id",      null: false
  end
  ...
  create_table "contest_partnerlink", force: :cascade do |t|
    t.integer "contest_id",             null: false
  ...
  create_table "contest_promotion", force: :cascade do |t|
    t.boolean  "is_active",               null: false
    t.datetime "updated_at",              null: false
    t.datetime "created_at",              null: false
  ...
  create_table "contest_style_contest_step", force: :cascade do |t|
    t.datetime "updated_at",                     null: false
    t.datetime "created_at",                     null: false
  ...
  create_table "countries_country", primary_key: "iso", force: :cascade do |t|
  ...
  create_table "django_facebook_facebook_invite", force: :cascade do |t|
    t.datetime "updated_at",                         null: false
    t.datetime "created_at",                         null: false
    t.integer  "user_id",                            null: false
    t.string   "user_invited",           limit: 255, null: false
    t.text     "message"
    t.string   "type",                   limit: 255
    t.string   "wallpost_id",            limit: 255
    t.boolean  "error",                              null: false
    t.text     "error_message"
    t.datetime "last_attempt"
    t.string   "reminder_wallpost_id",   limit: 255
  ...
  create_table "django_facebook_facebookcustomuser", force: :cascade do |t|
    t.string   "password",             limit: 128, null: false
    t.datetime "last_login",                       null: false
    t.boolean  "is_superuser",                     null: false
    t.string   "username",             limit: 30,  null: false
  ...
  create_table "django_facebook_facebookcustomuser_groups", force: :cascade do |t|
  ...
  create_table "django_facebook_facebookcustomuser_user_permissions", force: :cascade do |t|
    t.integer "facebookcustomuser_id", null: false
    t.integer "permission_id",         null: false
  end
  ...
  create_table "django_facebook_facebooklike", force: :cascade do |t|
    t.integer  "user_id",                null: false
  ...
  create_table "django_facebook_facebookprofile", force: :cascade do |t|
    t.text    "about_me"
    t.integer "facebook_id",          limit: 8
    t.text    "access_token"
    t.string  "facebook_name",        limit: 255
  ...
  create_table "django_facebook_facebookuser", force: :cascade do |t|
    t.integer "user_id",               null: false
    t.integer "facebook_id", limit: 8, null: false
    t.text    "name"
    t.string  "gender",      limit: 1
  ...
  create_table "django_messages_message", force: :cascade do |t|
  ...
  create_table "entity_entity", force: :cascade do |t|
    t.datetime "updated_at",                             null: false
    t.datetime "created_at",                             null: false
    t.integer  "site_id"
  ...
  create_table "entity_entity_category", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
  ...
  create_table "entity_entity_check_log", force: :cascade do |t|
    t.datetime "updated_at",    null: false
    t.datetime "created_at",    null: false
  ...
  create_table "entity_featured_fashiolista", force: :cascade do |t|
    t.datetime "updated_at",                                 null: false
    t.datetime "created_at",                                 null: false
    t.integer  "user_id",                                    null: false
    t.text     "description",                                null: false
  ...
  create_table "entity_give_away", primary_key: "entity_ptr_id", force: :cascade do |t|
    t.text     "description"
  ...
  create_table "entity_love", force: :cascade do |t|
    t.integer  "entity_id",     null: false
    t.integer  "user_id",       null: false
  ...
  create_table "entity_love_history", primary_key: "entity_id", force: :cascade do |t|
    t.date    "created_at", default: '2015-01-26', null: false
    t.integer "loves",      default: 0
  end

  create_table "entity_love_inactive", force: :cascade do |t|
    t.integer  "entity_id",     null: false
    t.integer  "user_id",       null: false
    t.integer  "influencer_id"
    t.integer  "location"
  ...
  create_table "entity_love_location", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
    t.string   "name",       limit: 50, null: false
  end
  ...
  create_table "entity_related_entity", force: :cascade do |t|
    t.datetime "updated_at",    null: false
    t.datetime "created_at",    null: false
  ...
  create_table "entity_scraping_log", force: :cascade do |t|
    t.datetime "updated_at",               null: false
    t.datetime "created_at",               null: false
    t.integer  "site_id"
    t.integer  "user_id",                  null: false
  ...
  create_table "entity_site", force: :cascade do |t|
    t.datetime "updated_at",                                                 null: false
    t.datetime "created_at",                                                 null: false
    t.string   "domain",                limit: 255,                          null: false
  ...
  create_table "entity_site_category", force: :cascade do |t|
    t.datetime "updated_at",                             null: false
    t.datetime "created_at",                             null: false
    t.string   "name",                       limit: 255, null: false
  ...
  create_table "entity_site_image", force: :cascade do |t|
    t.datetime "updated_at",               null: false
    t.datetime "created_at",               null: false
    t.integer  "site_id"
    t.boolean  "featured",                 null: false
  ...
  create_table "entity_style", force: :cascade do |t|
    t.string   "name",         limit: 255, null: false
    t.string   "slug",         limit: 50,  null: false
    t.integer  "order",                    null: false
    t.boolean  "is_active",                null: false
  ...
  create_table "entity_style_group", force: :cascade do |t|
    t.string   "name",         limit: 255, null: false
    t.string   "slug",         limit: 50,  null: false
    t.integer  "order",                    null: false
    t.boolean  "is_active",                null: false
  ...
  create_table "entity_stylegroup_style", force: :cascade do |t|
  ...
  create_table "entity_test_love", force: :cascade do |t|
    t.datetime "updated_at",                       null: false
    t.datetime "created_at",                       null: false
    t.integer  "entity_id",                        null: false
    t.integer  "user_id",                          null: false
    ...
    t.string   "version_task_started", limit: 255
  ...
  create_table "entity_trend_highlight", force: :cascade do |t|
    t.boolean  "is_active",                     null: false
    t.datetime "updated_at",                    null: false
    t.datetime "created_at",                    null: false
    t.string   "title",             limit: 255, null: false
    t.text     "short_description",             null: false
    t.string   "search_query",      limit: 255, null: false
  ...
  create_table "event_event", force: :cascade do |t|
    t.datetime "updated_at",                    null: false
    t.datetime "created_at",                    null: false
    t.string   "name",              limit: 255, null: false
    t.string   "slug",              limit: 50,  null: false
    ...
    t.string   "list_search",       limit: 255
    t.text     "sidebar"
    t.datetime "start",                         null: false
    t.datetime "end",                           null: false
    t.boolean  "is_active",                     null: false
  ...
  create_table "event_framework_communication_event_handler", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
  ...
  create_table "event_framework_event", force: :cascade do |t|
    t.datetime "updated_at",                 null: false
    t.datetime "created_at",                 null: false
    t.string   "name",           limit: 255, null: false
    t.string   "slug",           limit: 50,  null: false
  ...
  create_table "event_framework_event_binding", force: :cascade do |t|
    t.datetime "updated_at",      null: false
    t.datetime "created_at",      null: false
  ...
  create_table "event_framework_event_handler_queue", force: :cascade do |t|
    t.datetime "updated_at",       null: false
    t.datetime "created_at",       null: false
  ...
  create_table "event_framework_event_history", force: :cascade do |t|
    t.datetime "updated_at",        null: false
    t.datetime "created_at",        null: false
    t.integer  "user_id",           null: false
    t.integer  "event_id",          null: false
  ...
  create_table "event_framework_event_requirement_field", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
    t.integer  "event_id",               null: false
  ...
  create_table "gargoyle_switch", primary_key: "key", force: :cascade do |t|
  ...
  create_table "lists_base_list", force: :cascade do |t|
    t.datetime "updated_at",                null: false
    t.datetime "created_at",                null: false
    t.string   "name",          limit: 255, null: false
    t.string   "slug",          limit: 255, null: false
  ...
  create_table "lists_featured_look", force: :cascade do |t|
    t.boolean  "is_active",   null: false
    t.datetime "updated_at",  null: false
    t.datetime "created_at",  null: false
    t.integer  "userlist_id", null: false
  ...
  create_table "lists_list_item", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
  ...
  create_table "lists_user_list", force: :cascade do |t|
    t.datetime "updated_at",                     null: false
    t.datetime "created_at",                     null: false
    t.boolean  "is_active",                      null: false
  ...
  create_table "qandstats_default", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
  ...
  create_table "qandstats_group", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
    t.string   "title",      limit: 255, null: false
    t.string   "slug",       limit: 50,  null: false
  ...
  create_table "qandstats_page", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
    t.integer  "group_id"
    t.string   "title",      limit: 255, null: false
  ...
  create_table "qandstats_page_queries", force: :cascade do |t|
  ...
  create_table "qandstats_query", force: :cascade do |t|
    t.datetime "updated_at",              null: false
    t.datetime "created_at",              null: false
  ...
  create_table "reversion_revision", force: :cascade do |t|
  ...
  create_table "reversion_version", force: :cascade do |t|
  ...
  create_table "robots_rule", force: :cascade do |t|
    t.string  "robot",       limit: 255,                         null: false
    t.decimal "crawl_delay",             precision: 3, scale: 1
  end

  create_table "robots_rule_allowed", force: :cascade do |t|
  ...
  create_table "robots_rule_disallowed", force: :cascade do |t|
    t.integer "rule_id", null: false
    t.integer "url_id",  null: false
  end
  ...
  create_table "robots_rule_sites", force: :cascade do |t|
    t.integer "rule_id", null: false
    t.integer "site_id", null: false
  end
  ...
  create_table "robots_url", force: :cascade do |t|
    t.string "pattern", limit: 255, null: false
  end

  create_table "simple_mail_email_click_track", primary_key: "user_id", force: :cascade do |t|
    t.datetime "received_at"
    t.string   "campaign",    limit: 255
    t.string   "url",         limit: 255
  end

  create_table "simple_mail_email_open_track", primary_key: "user_id", force: :cascade do |t|
    t.datetime "received_at"
    t.string   "campaign",    limit: 255
  end

  create_table "simple_mail_sent_mail", force: :cascade do |t|
    t.integer  "user_id"
  ...
  create_table "simple_notification_dismissed_notification", force: :cascade do |t|
    t.datetime "updated_at",      null: false
    t.datetime "created_at",      null: false
    t.integer  "user_id",         null: false
  ...
  create_table "simple_notification_notification", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
  ...
  create_table "tagging_tag", force: :cascade do |t|
    t.string  "name",        limit: 50, null: false
    t.string  "slug",        limit: 50, null: false
    t.integer "type_id"
  ...
  create_table "tagging_tag_type", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
    t.string   "name",       limit: 50, null: false
    t.string   "slug",       limit: 50, null: false
  ...
  create_table "tagging_taggeditem", force: :cascade do |t|
  ...
  create_table "tcc_comment", force: :cascade do |t|
    t.integer  "content_type_id",               null: false
  ...
  create_table "tcc_comment_unsubscribers", force: :cascade do |t|
    t.integer "comment_id", null: false
    t.integer "user_id",    null: false
  end
  ...
  create_table "tcc_spamreport", force: :cascade do |t|
    t.integer "comment_id", null: false
    t.integer "user_id",    null: false
  end
  ...
  create_table "tcc_subscription", force: :cascade do |t|
    t.integer  "user_id",    null: false
    t.integer  "comment_id", null: false
    t.datetime "read_at"
  end
  ...
  create_table "upload_file", force: :cascade do |t|
    t.datetime "updated_at",               null: false
    t.datetime "created_at",               null: false
    t.string   "name",         limit: 255, null: false
    t.integer  "width"
  ...
  create_table "user_address", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
    t.integer  "user_id",                      null: false
  ...
  create_table "user_alpha_invite", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
    t.string   "email",      limit: 75, null: false
  end

  create_table "user_authentication_token", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
    t.integer  "user_id",               null: false
  ...
  create_table "user_blocked_ip", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
  ...
  create_table "user_communication", force: :cascade do |t|
    t.datetime "updated_at",                       null: false
    t.datetime "created_at",                       null: false
    t.string   "name",                 limit: 255, null: false
    t.string   "slug",                 limit: 50,  null: false
    ...
    t.text     "html_email"
    t.text     "text_email"
    t.string   "from_email_overwrite", limit: 255
    t.text     "subject"
  ...
  create_table "user_communication_category", force: :cascade do |t|
    t.datetime "updated_at",                  null: false
    t.datetime "created_at",                  null: false
    t.string   "name",            limit: 255, null: false
    t.string   "slug",            limit: 50,  null: false
  ...
  create_table "user_communication_queue", force: :cascade do |t|
    t.datetime "updated_at",                  null: false
    t.datetime "created_at",                  null: false
  ...
  create_table "user_content_flag", force: :cascade do |t|
    t.integer  "user_id",         null: false
  ...
  create_table "user_facebook_invite", force: :cascade do |t|
    t.datetime "updated_at",                         null: false
    t.datetime "created_at",                         null: false
    t.integer  "user_id",                            null: false
    t.string   "user_invited",           limit: 255, null: false
  ...
  create_table "user_facebook_page_tab", force: :cascade do |t|
    t.datetime "updated_at",                null: false
    t.datetime "created_at",                null: false
    t.integer  "user_id"
  ...
  create_table "user_facebook_wallpost", force: :cascade do |t|
    t.datetime "updated_at",               null: false
    t.datetime "created_at",               null: false
    t.integer  "user_id",                  null: false
    t.integer  "entity_id",                null: false
  ...
  create_table "user_feature_location", force: :cascade do |t|
    t.datetime "updated_at",            null: false
    t.datetime "created_at",            null: false
    t.string   "slug",       limit: 50, null: false
    t.boolean  "is_active",             null: false
  ...
  create_table "user_feature_user", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
    t.integer  "user_id",    null: false
  ...
  create_table "user_featureuser_locations", force: :cascade do |t|
  ...
  create_table "user_featureuser_style", force: :cascade do |t|
    t.integer "featureuser_id", null: false
    t.integer "style_id",       null: false
  end
  ...
  create_table "user_featureuser_style_groups", force: :cascade do |t|
    t.integer "featureuser_id", null: false
    t.integer "stylegroup_id",  null: false
  end
  ...
  create_table "user_follow", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
    t.integer  "user_id",    null: false
    t.integer  "target_id",  null: false
  ...
  create_table "user_last_login", primary_key: "user_id", force: :cascade do |t|
    t.date    "created_at",     null: false
  ...
  create_table "user_mail_stat", force: :cascade do |t|
    t.datetime "updated_at",              null: false
    t.datetime "created_at",              null: false
  ...
  create_table "user_mailredirect", force: :cascade do |t|
  ...
  create_table "user_notification_log", force: :cascade do |t|
    t.datetime "updated_at",   null: false
    t.datetime "created_at",   null: false
    t.integer  "user_id",      null: false
  ...
  create_table "user_open_graph_share", force: :cascade do |t|
    t.integer  "user_id",                      null: false
    t.string   "action_domain",    limit: 255, null: false
  ...
  create_table "user_profile_blog", force: :cascade do |t|
    t.datetime "updated_at",                 null: false
    t.datetime "created_at",                 null: false
    t.integer  "profile_id",                 null: false
  ...
  create_table "user_profile_header", force: :cascade do |t|
    t.integer "profile_id",              null: false
    t.text    "content"
    t.integer "width"
    t.integer "height"
  ...
  create_table "user_registration_source", force: :cascade do |t|
    t.datetime "updated_at",               null: false
    t.datetime "created_at",               null: false
    t.integer  "user_id",                  null: false
    t.string   "utm_source",   limit: 255
  ...
  create_table "user_status_type", force: :cascade do |t|
    t.datetime "updated_at",                  null: false
    t.datetime "created_at",                  null: false
    t.string   "name",            limit: 255, null: false
    t.string   "slug",            limit: 50,  null: false
  ...
  create_table "user_stringcheck", force: :cascade do |t|
    t.string   "string",               limit: 75,  null: false
    t.integer  "type",                             null: false
    t.boolean  "used",                             null: false
    t.string   "usage_description",    limit: 75
    t.string   "creation_description", limit: 255
    t.datetime "created_at",                       null: false
  end

  create_table "user_tagmatch", force: :cascade do |t|
  ...
  create_table "user_user_delete_request", force: :cascade do |t|
    t.datetime "updated_at",                          null: false
    t.datetime "created_at",                          null: false
    t.integer  "user_id",                             null: false
    t.string   "denormalized_username",   limit: 255
  ...
  create_table "user_user_device", force: :cascade do |t|
    t.datetime "updated_at",                   null: false
    t.datetime "created_at",                   null: false
    t.integer  "user_id",                      null: false
    t.integer  "device_type"
    t.string   "device_id",        limit: 255
    t.string   "device_gcm_token", limit: 255
  end
  ...
  create_table "user_user_group", force: :cascade do |t|
    t.datetime "updated_at",             null: false
    t.datetime "created_at",             null: false
    t.integer  "user_id",                null: false
    t.string   "slug",       limit: 255, null: false
  ...
  create_table "user_user_notification_setting", force: :cascade do |t|
    t.datetime "updated_at",    null: false
    t.datetime "created_at",    null: false
    t.integer  "user_id",       null: false
    t.integer  "verb_id",       null: false
  ...
  create_table "user_user_preference", force: :cascade do |t|
    t.datetime "updated_at",  null: false
    t.datetime "created_at",  null: false
    t.integer  "category_id", null: false
    t.integer  "user_id",     null: false
  ...
  create_table "user_user_style", force: :cascade do |t|
    t.datetime "updated_at", null: false
    t.datetime "created_at", null: false
    t.integer  "user_id",    null: false
    t.integer  "style_id",   null: false
  ...
  create_table "user_user_suggestion", force: :cascade do |t|
    t.datetime "updated_at",        null: false
    t.datetime "created_at",        null: false
    t.integer  "user_id",           null: false
